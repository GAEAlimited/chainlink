...
require (
	...
	github.com/smartcontractkit/chainlink-common v0.1.7-0.20240604191334-50024057faae
...
require (
	...
	github.com/smartcontractkit/chainlink-solana v1.0.3-0.20240603183542-58ab0f61506b // indirect
